...
const Index = ({ children }: { children: React.ReactNode }) => {
  ...
  return (
    <div className='flex h-screen bg-gray-200'>
      <aside className={`fixed inset-y-0 left-0 w-64 bg-white border-r overflow-y-auto z-30 transition-transform transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
        <div className='flex flex-col h-full'>
          ...
          <div className='flex flex-col items-center mt-6'>
            <img className='object-cover w-24 h-24 rounded-full' src='https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80' alt='avatar' />
            <h4 className='mt-2 text-gray-800 dark:text-gray-200'>John Doe</h4>
            <p className='mt-1 text-sm text-gray-600 dark:text-gray-400'>john@example.com</p>
          </div>
