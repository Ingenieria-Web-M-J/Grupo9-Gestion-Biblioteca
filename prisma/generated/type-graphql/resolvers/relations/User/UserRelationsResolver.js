...
const UserProductArgs_1 = require("./args/UserProductArgs");
const UserSessionsArgs_1 = require("./args/UserSessionsArgs");
const UserTransactionArgs_1 = require("./args/UserTransactionArgs");
...
let UserRelationsResolver = class UserRelationsResolver {
    ...
    async Product(user, ctx, info, args) {
        const { _count } = (0, helpers_1.transformInfoIntoPrismaArgs)(info);
        return (0, helpers_1.getPrismaFromContext)(ctx).user.findUniqueOrThrow({
            where: {
                id: user.id,
    ...
    async Transaction(user, ctx, info, args) {
        const { _count } = (0, helpers_1.transformInfoIntoPrismaArgs)(info);
        return (0, helpers_1.getPrismaFromContext)(ctx).user.findUniqueOrThrow({
            where: {
                id: user.id,
...
tslib_1.__decorate([
    ...
    tslib_1.__param(3, TypeGraphQL.Args()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [User_1.User, Object, Object, UserProductArgs_1.UserProductArgs]),
    tslib_1.__metadata("design:returntype", Promise)
], UserRelationsResolver.prototype, "Product", null);
tslib_1.__decorate([
    ...
    tslib_1.__param(3, TypeGraphQL.Args()),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [User_1.User, Object, Object, UserTransactionArgs_1.UserTransactionArgs]),
    tslib_1.__metadata("design:returntype", Promise)
], UserRelationsResolver.prototype, "Transaction", null);
